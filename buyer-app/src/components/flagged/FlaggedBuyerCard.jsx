    ...
    <div className="bg-white rounded-lg shadow p-6">
      <div className="flex items-start gap-4">
        ...
        <div className="flex-1">
          ...
          <p className="text-sm text-gray-600 mt-1">Reason: {flag.email}</p>
          <p className="text-sm text-gray-600 mt-1">Reason: {flag.phone}</p>
          <p className="text-sm text-gray-600 mt-1">Reason: {flag.location}</p>
        </div>
      </div>
    </div>
  );
