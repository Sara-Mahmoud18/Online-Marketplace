...
// import OrderCard from "./OrderCard";
// import OrderDetailsModal from "./orderDetalies";
// import { Search, Filter, Download, ShoppingBag, DollarSign, Clock } from "lucide-react";

// const OrdersView = ({ orders, setOrders, currentSellerId }) => {  // Add currentSellerId prop
//   const [selectedOrder, setSelectedOrder] = useState(null);
...
//           <button className="mt-4 md:mt-0 px-6 py-3 bg-gradient-to-r from-blue-600 to-indigo-600 text-white font-semibold rounded-xl hover:from-blue-700 hover:to-indigo-700 transition-all duration-200 transform hover:-translate-y-0.5 active:translate-y-0 shadow-lg hover:shadow-xl flex items-center gap-2">
  ...
  const handleExportOrders = () => {
    ...
    const csvData = filteredOrders.map(order => {
      ...
      return [
        ...
        orderDate,
        deliveryDate,
        `"${order.buyerUsername || 'Customer'}'s Order"` // Wrap in quotes for CSV
      ];
    });
